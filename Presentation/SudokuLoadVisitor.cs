namespace Input_and_Output
{
    public class SudokuLoadVisitor : ISudokuLoadVisitor
    {
        ...
        public void VisitLoadRegularSudoku(RegularSudoku sudoku, string filePath)
        {
            string sudokuData = File.ReadAllText(filePath);
            char lastLetter = filePath[filePath.Length - 1];
        ...
        private int[,] ParseRegularSudokuData(string data, int size)
        {
        ...
        public void VisitLoadJigsawSudoku(JigsawSudoku sudoku, string filePath)
        {
            string jigsawData = File.ReadAllText(filePath);
        ...
        public void VisitLoadSamuraiSudoku(SamuraiSudoku sudoku, string filePath)
        {
